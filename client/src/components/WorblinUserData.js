  ...
  // Count the occurrences of each score
    ...
    return (
        <div className='agDiv1SubUser'>
            ...
            <h2 className="userGameHist">Worblin History</h2>
            <p className="average">Your average Worblin score: {averageUserWorblinScore}</p>
            <Bar data={chartData} options={chartOptions} />
        </div>
    );
}

export default WorblinUserData;